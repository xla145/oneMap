...
默认首页已升级为 GIS 工作台：常驻地图、图层目录、对象属性、空间工具与任务办理。公众介绍门户和可视化需求说明随项目提供。最终可运行版本位于本仓库 `prototype/gis/`。

- 地图工作台：启动服务后打开 `http://127.0.0.1:5190/`。
- 公众门户：`http://127.0.0.1:5190/gis/portal.html`。
