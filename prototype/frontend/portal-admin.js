...
export function createPortalAdmin(ctx){
  ...
  document.addEventListener('submit',async e=>{
    ...
    try{
      if(f.id==='pm-list-filter'){listQuery=v.q.trim();render();}
